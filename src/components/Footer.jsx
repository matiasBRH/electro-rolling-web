                    ...
                    <div className="footer-col col d-flex justify-content-around align-items-center">
                        ...
                        <div className="col-links">
                            <ul>
                                ...
                                <li><NavLink className="text-white" to="/about"><i className="fa fa-users" aria-hidden="true"></i> Conocenos </NavLink></li>
                                <li><NavLink className="text-white" to="/*"><i className="fa fa-address-book-o" aria-hidden="true"></i> Terminos y condiciones </NavLink></li>
                                <li><NavLink className="text-white" to="/*"><i className="fa fa-gavel" aria-hidden="true"></i> Legales </NavLink></li>
                            </ul>
                        </div>
                        {/* columna 3 */}
                        <div className="col-links-2">
                            <ul>
                                ...
                                <li><NavLink className="text-white" to="/*"><i className="fa fa-instagram" aria-hidden="true"></i> Instagram </NavLink></li>
                                <li><NavLink className="text-white" to="/*"><i className="fa fa-facebook" aria-hidden="true"></i> Facebook </NavLink></li>
                                <li><NavLink className="text-white" to="/*"><i className="fa fa-twitter" aria-hidden="true"></i> Twitter </NavLink></li>
                            </ul>
